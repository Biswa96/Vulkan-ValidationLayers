...
static const layer_data::unordered_map<std::string, VkValidationFeatureDisable> VkValFeatureDisableLookup2 = {
    {"VK_VALIDATION_FEATURE_DISABLE_SHADER_VALIDATION_CACHING_EXT", VK_VALIDATION_FEATURE_DISABLE_SHADER_VALIDATION_CACHING_EXT},
};
